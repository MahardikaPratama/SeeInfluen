    ...
    <div className="w-80 px-12 h-screen shadow-md text-white">
      <Link to="/">
        <div className="p-6 flex items-center space-x-4">
          <div className="flex flex-row text-white p-3 rounded-xl bg-[#5d5fef]">
            <svg
              width="50"
              height="50"
              viewBox="0 0 79 79"
              ...
              >
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    <defs>
                      <style>
                        {`.cls-1{fill:#ffffff;stroke:#ffffff;strokeLinecap:round;strokeLinejoin:round;strokeWidth:2px;}.cls-2{fill:rgba(255, 255, 255, 0.5);}`}
                      </style>
                    </defs>
                    <title></title>
